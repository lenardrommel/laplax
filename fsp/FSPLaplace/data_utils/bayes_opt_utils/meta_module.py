# https://github.com/chenwydj/learning-to-learn-by-gradient-descent-by-gradient-descent/blob/master/meta_module.py
...
class MetaLinear(MetaModule):
    ...
    def forward(self, x):
        return F.linear(x, self.weight.double(), self.bias.double())
...
class MetaConv2d(MetaModule):
    ...
    def forward(self, x):
        return F.conv2d(x, self.weight.double(), self.bias.double(), self.stride, self.padding, self.dilation, self.groups)
...
class MetaConvTranspose2d(MetaModule):
    ...
    def forward(self, x, output_size=None):
        ...
        return F.conv_transpose2d(x, self.weight.double(), self.bias.double(), self.stride, self.padding,
...
class MetaBatchNorm2d(MetaModule):
    ...
    def forward(self, x):
        return F.batch_norm(x, self.running_mean, self.running_var, self.weight.double(), self.bias.double(),
