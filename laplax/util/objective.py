...
from laplax.enums import CovarianceStructure, LossFn  # noqa: TC001
...
def create_kernel_fn(
    kernel_fn: Callable[[PredArray, PredArray], Float],
) -> Callable[[PredArray, PredArray], Float]:
    pass
...
#     *,
#     structure: CovarianceStructure = CovarianceStructure.KRONECKER,
#     solve_fn: Callable[
...
#     """  # noqa: D205, DOC201
#     if structure == CovarianceStructure.NONE:
...
#             )
#             K_c_c = prior_cov_kernel(context_points["context"])
#             left = jax.scipy.linalg.solve(K_c_c, f_c, assume_a="sym")
#             return 0.5 * jnp.einsum("ij,ij->", f_c, left)

#     if structure == CovarianceStructure.KRONECKER:
